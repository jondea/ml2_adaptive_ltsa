function mappedX = ltsa_weighted(X, no_dims, k, eig_impl)
...
% (C) Laurens van der Maaten, Delft University of Technology
    ...
    for i=1:n
        ...
        tBi = eye(kt)  - Gi * Gi';
        Bi{i} = tBi * inv(diag(Weight_MatrixI)) * inv(diag(Weight_MatrixI)) * tBi';  
        Bi{i} = Bi{i}./(1/kt);
    end
